...
const PRODUCTS = [
  // SHOES
  {cat:"shoes", name:"Adidas Superstar", sizes:[3,4,5,6,7,8], price:100, style:["trendy","casual"], pairsWith:["tops","shorts"], link:"https://www.adidas.com/us/superstar-ii-shoes/JH7033.html"},
  {cat:"shoes", name:"Isabel Marant Bekett Sneakers - Ecru", sizes:[3,4,5,6,7,8], price:850, style:["trendy","edgy"], pairsWith:["tops","shorts"], link:"https://us.isabelmarant.com/products/bk0010faa1e19s23ec-bekett-sneakers-ecru"},
  {cat:"shoes", name:"Hoka Clifton 10 Running Shoes", sizes:[4,5,6,7,8], price:155, style:["sporty","comfy"], pairsWith:["tops","shorts"], link:"https://www.dickssportinggoods.com/p/hoka-womens-clifton-10-running-shoes-25fhqwclftn10blckftw/25fhqwclftn10blckftw"},
  {cat:"shoes", name:"Vans Old Skool", sizes:[3,4,5,6,7,8], price:65, style:["casual","edgy"], pairsWith:["tops","shorts"], link:"https://www.vans.com/en-us/p/shoes/icons/old-skool-5205/old-skool-shoe-VN000D3HY28"},
  {cat:"shoes", name:"Dr. Martens 1461 Smooth Leather Oxford Shoes", sizes:[3,4,5,6,7,8], price:130, style:["edgy","classic"], pairsWith:["tops","trousers"], link:"https://www.drmartens.com/uk/en_gb/1461-smooth-leather-oxford-shoes-black/p/11838002"},

  // DRESSES
  {cat:"dresses", name:"Boho Halter V-Neck Open Back Maxi Dress", sizes:[8,10,12,14,16], price:79.95, style:["summer","cute","festival"], pairsWith:["shoes"], link:"https://bohobeachhut.com/products/boho-halter-v-neck-open-back-maxi-dress"},
  {cat:"dresses", name:"Oh Polly Leya A-Line Mini Dress - Black", sizes:[6,8,10,12], price:62, style:["party","trendy"], pairsWith:["shoes"], link:"https://us.ohpolly.com/products/leya-a-line-mini-dress-black"},
  {cat:"dresses", name:"Eterne Long Sleeve Crewneck Maxi Dress - Black", sizes:[6,8,10,12,14], price:265, style:["classic","smart"], pairsWith:["shoes"], link:"https://www.revolve.com/eterne-long-sleeve-crewneck-maxi-dress-in-black/dp/ERNE-WD2/"},
  {cat:"dresses", name:"Zara Fitted Wrap Dress - Black", sizes:[6,8,10,12,14,16], price:49.90, style:["smart","party"], pairsWith:["shoes"], link:"https://www.zara.com/us/en/fitted-wrap-dress-p01165462.html"},
  {cat:"dresses", name:"ASOS DESIGN Square Neck Midi Dress - Floral", sizes:[6,8,10,12,14], price:64.99, style:["summer","cute","school"], pairsWith:["shoes"], link:"https://www.asos.com/us/asos-design/asos-design-square-neck-midi-dress-in-floral-print/prd/209150878"},
